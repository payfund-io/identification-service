...
import { IDENTIFICATION_SERVICE_V1_PACKAGE_NAME } from './protobuf/identification-service.pb';
...
async function bootstrap() {
  ...
  const options = {
    ...
    options: {
      ...
      package: [HEALTH_V1_PACKAGE_NAME, IDENTIFICATION_SERVICE_V1_PACKAGE_NAME],
      protoPath: [
